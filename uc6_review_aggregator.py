...
<div class="header-bar">
    <h2 style="margin:0">⭐ Review & Sentiment Aggregator</h2>
    <p style="margin:0.3rem 0 0 0; opacity:0.9; font-size:0.95rem">
        Google · Zomato · Swiggy &nbsp;|&nbsp; Unified analysis, themes & ready-to-post responses &nbsp;|&nbsp; OrangeTree Global × Claude AI
    </p>
</div>
""", unsafe_allow_html=True)
...
st.markdown("""
<div class="intro-box">
    <h4 style="margin:0 0 0.5rem 0">📌 What does this tool do — and how does it save you time?</h4>
    <p style="margin:0 0 0.5rem 0">
        Most restaurant and SME owners check Google, Zomato, and Swiggy reviews separately — copy-pasting between
        apps, manually figuring out patterns, and writing individual responses one by one. That's hours of work every week.
    </p>
    <p style="margin:0 0 0.5rem 0">
        This tool lets you <b>paste all your reviews in one place</b>. Claude AI reads every single one, identifies
        what customers love, what's hurting your ratings, recurring themes across platforms,
        and even writes <b>personalised, ready-to-post responses</b> for your most important reviews.
    </p>
    <p style="margin:0">
        <b>What normally takes 2–3 hours of manual work takes under 2 minutes here.</b>
        The analysis helps you prioritise what to fix in your operations — not just online reputation, but the actual issues driving negative reviews.
    </p>
</div>
""", unsafe_allow_html=True)

# How to steps
st.markdown("#### 🗺️ How to use this — 3 steps")
col_s1, col_s2, col_s3 = st.columns(3)
with col_s1:
    st.markdown("""
    <div style="background:#f8f9fa; border-radius:8px; padding:1rem; text-align:center; height:140px">
        <div style="font-size:2rem">📋</div>
        <b>Step 1</b><br>
        <small>Set up in the sidebar: enter your API key and your business name. This helps Claude write responses that sound like you.</small>
...
with col_s2:
    ...
    <div style="background:#f8f9fa; border-radius:8px; padding:1rem; text-align:center; height:140px">
        <div style="font-size:2rem">📝</div>
        <b>Step 2</b><br>
        <small>Paste reviews from Google, Zomato, and Swiggy into the tabs below — or load the sample data to see how it works.</small>
    </div>""", unsafe_allow_html=True)
with col_s3:
    st.markdown("""
    <div style="background:#f8f9fa; border-radius:8px; padding:1rem; text-align:center; height:140px">
        <div style="font-size:2rem">📊</div>
        <b>Step 3</b><br>
        <small>Hit Analyse — get sentiment breakdown, what's working, what to fix, and AI-written responses you can post right away.</small>
    </div>""", unsafe_allow_html=True)
...
with st.sidebar:
    ...
    st.markdown("<small>This connects the tool to Claude AI. Your key is used only for this session and never stored. Get a free key at console.anthropic.com</small>", unsafe_allow_html=True)
    api_key = st.text_input("API Key", type="password", label_visibility="collapsed", placeholder="sk-ant-...")

    st.markdown("---")
    st.markdown("**🤖 AI Model**")
    st.markdown("<small>claude-sonnet is recommended — fast and accurate for review analysis.</small>", unsafe_allow_html=True)
    model = st.selectbox("Model", ["claude-opus-4-8", "claude-sonnet-4-6", "claude-haiku-4-5-20251001"],
                         index=1, label_visibility="collapsed")

    st.markdown("---")
    st.markdown("### 🏪 Your Business")
    st.markdown("<small>This information helps Claude write review responses that sound like they genuinely came from your business — not a generic template.</small>", unsafe_allow_html=True)
    ...
    st.markdown("<small>No reviews handy? Load sample F&B reviews to see exactly how the analysis works before using your real data.</small>", unsafe_allow_html=True)
    ...
    st.markdown("---")
    st.markdown("""
    <div style="background:#f0f6ff; border-radius:8px; padding:0.8rem; font-size:0.82rem">
    💡 <b>Pro tip:</b> For best results, paste at least 5–10 reviews per platform.
    The more reviews you include, the more accurate the pattern analysis.
    </div>""", unsafe_allow_html=True)
...
# Options
st.markdown("---")
st.markdown("#### ⚙️ Analysis options *(optional)*")
